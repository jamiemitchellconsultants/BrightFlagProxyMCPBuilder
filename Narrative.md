...
| [29](#entry-add-prompt-20-shared-home-lab-audience-and-a-completable-oauth-flow) | 2026-08-02 | Add prompt 20: shared home-lab audience and a completable OAuth flow | product | Supersede Prompt 18 rather than complete it, and state that it must not be applied. |
...
| [34](#entry-add-fake-upstream-and-upstream-class-stages-and-make-payment-an-ordinary) | 2026-08-04 | Add fake upstream and upstream-class stages, and make payment an ordinary capability | product | **Stage 21** hosts Stage 3's fake twice from one shared component — the existing in-process loopback host, unchanged, and a new `tools/BrightFlagMcp.FakeUpstream` packaged as its own image. |
...
<a id="entry-add-prompt-20-shared-home-lab-audience-and-a-completable-oauth-flow"></a>

## Entry 29 — 2026-08-02 — Add prompt 20: shared home-lab audience and a completable OAuth flow
...
## Entry 30 — 2026-08-02 — Prepare the ai-mcp-server development deployment for adversarial review
...
<a id="entry-correct-prompt-20-to-retain-the-fixed-token-mode"></a>

## Entry 31 — 2026-08-03 — Correct Prompt 20 to retain the fixed-token mode
...
<a id="entry-frame-prompt-18-s-secret-store-exposure-as-a-presumption-not-a-fact"></a>

## Entry 32 — 2026-08-03 — Frame prompt 18's secret-store exposure as a presumption, not a fact
...
<a id="entry-add-fake-upstream-and-upstream-class-stages-and-make-payment-an-ordinary"></a>

## Entry 34 — 2026-08-04 — Add fake upstream and upstream-class stages, and make payment an ordinary capability
