...
| [15](#entry-add-binding-agent-instructions-and-teach-the-pattern-in-prompt-2) | 2026-07-30 | Add binding agent instructions and teach the pattern in Prompt 2 | product | Adopt the pattern, adapted rather than copied. `CLAUDE.md` is binding regardless of which tool reads it and is the only place rules live; the six pointers say only that it is authoritative and that instruction changes belong there. `CLAUDE. |
...
## Entry 15 — 2026-07-30 — Add binding agent instructions and teach the pattern in Prompt 2
